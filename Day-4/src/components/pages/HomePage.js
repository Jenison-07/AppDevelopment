    ...
    <div className="home-container">
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Your Trusted Furniture Shop</h1>
          <p>Bringing quality Furniture products to your doorstep.</p>
        </div>
      </section>
      ...
      <section className="contact-info">
        ...
        <div className="info-item">
          <p><strong>Address:</strong> 123 cage Street, City</p>
        </div>
        <div className="info-item">
      ...
      <footer className="footer">
        <div className="footer-content">
          <p>&copy; 2023 Your Furniture Shop</p>
        </div>
      </footer>
    </div>
  );
